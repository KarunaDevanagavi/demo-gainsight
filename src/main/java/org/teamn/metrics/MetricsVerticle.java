...
public class MetricsVerticle extends BusModBase implements Handler<Message<JsonObject>>{
    ...
    public void start() {
        super.start() ;
        String address = getOptionalStringConfig("address", "com.bloidonia.metrics");
        String domain = getOptionalStringConfig("domain", "com.bloidonia.domain");
        metrics = new MetricRegistry() ;
        timers = new HashMap<>() ;
        gauges = new ConcurrentHashMap<>() ;
        JmxReporter.forRegistry( metrics ).inDomain(domain).build().start() ;
